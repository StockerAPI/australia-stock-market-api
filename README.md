# Australia stock market API

Real-time Australia stock market API with WebSocket, OHLCV, and snapshot endpoints for ASX.

## Build With Australia Market Data

Kun Data provides a token-authenticated API stack for developers who need Australia market data in products that must load fast, stream live prices, and support charting or screening workflows.

This repository is focused on Australia coverage with support for ASX and is designed for teams building broker dashboards, watchlists, quant tools, stock screeners, mobile apps, and market overview pages.

## Why Developers Search For This

Developers usually need one or more of these:

- Real-time Australia stock market API
...
`Australia stock market API | ASX API | Australian stock data API | Australia OHLCV API`
...
### Does this support real-time Australia market data?
...
If you need Australia market data coverage for ASX, start with the product page and documentation:
