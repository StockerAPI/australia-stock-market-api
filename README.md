...
Kun Data provides real-time market data for Australia through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Australia market coverage with support for ASX.

## API Capabilities

- Real-time WebSocket market data for Australia
...
This repository is designed to make Australia market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/australia-stock-market-api
