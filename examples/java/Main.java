...
public class Main {
    ...
    private static final String MARKET = "AU";
    private static final String EXCHANGE = "ASX";
    private static final String SYMBOL = "ASX:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"ASX:000040\",\"ASX:005930\"],\"replay\":\"last\"}";
